...
object SettingIcons {
    ...
    private val map = mapOf(
            ...
            "今日卡排列" to IconSpec(R.drawable.s_more_rows, R.color.icon_blue),
            "课程预告范围" to IconSpec(R.drawable.s_weeks, R.color.icon_teal),
            "生日提醒" to IconSpec(R.drawable.s_bell, R.color.icon_pink),
