...
import com.Tangle.timetable.schedule_import.Common.TYPE_BNUZ
import com.Tangle.timetable.schedule_import.Common.TYPE_CF
import com.Tangle.timetable.schedule_import.Common.TYPE_HELP
import com.Tangle.timetable.schedule_import.Common.TYPE_HNIU
import com.Tangle.timetable.schedule_import.Common.TYPE_HNUST
import com.Tangle.timetable.schedule_import.Common.TYPE_JNU
import com.Tangle.timetable.schedule_import.Common.TYPE_LOGIN
import com.Tangle.timetable.schedule_import.Common.TYPE_PKU
import com.Tangle.timetable.schedule_import.Common.TYPE_QZ
import com.Tangle.timetable.schedule_import.Common.TYPE_QZ_BR
import com.Tangle.timetable.schedule_import.Common.TYPE_QZ_CRAZY
import com.Tangle.timetable.schedule_import.Common.TYPE_QZ_OLD
import com.Tangle.timetable.schedule_import.Common.TYPE_QZ_WITH_NODE
import com.Tangle.timetable.schedule_import.Common.TYPE_URP
import com.Tangle.timetable.schedule_import.Common.TYPE_URP_NEW
import com.Tangle.timetable.schedule_import.Common.TYPE_ZF
import com.Tangle.timetable.schedule_import.Common.TYPE_ZF_1
import com.Tangle.timetable.schedule_import.Common.TYPE_ZF_NEW
import com.Tangle.timetable.schedule_import.bean.SchoolInfo
...
class SchoolListActivity : BaseTitleActivity(), OnQuickSideBarTouchListener {
    ...
    override fun createTitleBar() = LinearLayoutCompat(this).apply {
        ...
        addView(LinearLayoutCompat(context).apply {
            ...
            addView(AppCompatImageButton(context).apply {
                ...
                setBackgroundResource(outValue.resourceId)
                setColorFilter(color(R.color.colorAccent))
                setOnClickListener {
    ...
    private fun initSchoolList() {
        ...
        schools.apply {
            ...
            add(SchoolInfo("M", "茅台学院", "https://jwxt.mtxy.edu.cn/", TYPE_ZF_NEW))
