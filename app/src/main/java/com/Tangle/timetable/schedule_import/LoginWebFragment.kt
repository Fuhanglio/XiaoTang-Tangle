...
import com.Tangle.timetable.schedule_import.exception.CheckCodeErrorException
...
import com.Tangle.timetable.schedule_import.login_school.hust.MobileHub
import com.Tangle.timetable.schedule_import.login_school.jlu.UIMS
...
class LoginWebFragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (viewModel.school != "苏州大学") {
            ...
            tv_tip.setOnClickListener {
                Toasty.info(context!!, "请自行查阅校园网接入指南").show()
            }
        }
    ...
    private fun initEvent() {
        ...
        fab_login.setImageResource(R.drawable.ic_login_arrow)
