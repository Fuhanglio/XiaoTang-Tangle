...
val CourseManageFragment.fab_add: com.google.android.material.button.MaterialButton
    get() = findViewCompat(R.id.fab_add)

val CourseManageFragment.rv_list: androidx.recyclerview.widget.RecyclerView
    get() = findViewCompat(R.id.rv_list)

val ScheduleManageFragment.fab_add: com.google.android.material.button.MaterialButton
    get() = findViewCompat(R.id.fab_add)

val ScheduleManageFragment.rv_list: androidx.recyclerview.widget.RecyclerView
    get() = findViewCompat(R.id.rv_list)
